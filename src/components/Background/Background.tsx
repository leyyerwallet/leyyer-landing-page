...
const Background = ({className}: BackgroundProps) => {
    return (
        ...
        >
            <div
                className="relative brightness-110 blur-sm left-[calc(50%+3rem)] aspect-[1155/678] w-[70.125rem] -translate-x-1/2 bg-gradient-to-tr from-[#00D395] to-[#ffffff] opacity-30 sm:left-[calc(50%)] sm:bottom-[calc(50%)] sm:w-[72.1875rem]"
                style={{
                    clipPath:
