...
const Steps: React.FC = () => {
  return (
    <div className="relative flex place-content-center text-balance">
      <Background
        className={'top-[calc(100%-90rem)] sm:top-[calc(100%-90rem)]'}
      />
      <div className="px-[2rem] text-center max-w-[1408px] mx-auto p-2 md:p-8 gap-2 md:gap-12 m-2 md:m-[1rem]">
        <Background
          className={'top-[calc(100%-50rem)] sm:top-[calc(100%-50rem)]'}
        />
        <Typography
            ...
            <Card placeholder={undefined} className="m-8 w-96 shadow-2xl">
              ...
              <CardBody placeholder={undefined} className="text-center">
                <Typography
                  ...
                  variant="h5"
                  color="blue-gray"
                  className="mb-2 text-[25px] flex-center"
                >
                  Get a Wallet
                </Typography>
                <Typography
                ...
                >
                  Get started with the application. Download mobile or use the
                  web app at your disposal
                </Typography>
              </CardBody>
            </Card>
          </div>
            ...
            <Card placeholder={undefined} className="m-8 w-96 shadow-2xl">
              ...
              <CardBody placeholder={undefined} className="text-center">
                ...
                <Typography placeholder={undefined} className="text-[16px]">
                  Create a new wallet with ease.
                  <br />
                  All wallets created at your disposal
                </Typography>
              </CardBody>
            </Card>
          </div>
